...
const works = [
  {
    ...
    productionTime: '2週間',
    commitment:
      '誰に見てもらうかをよく考え作成いたしました。トップページの一番上に簡易的なプロフィールを持ってくることで、他のページやスクロールをしなくても自分のことがわかってもらえるように設計しました。フロントエンドにNext.jsを採用したことでページの再読み込みがなくなり、ストレスなくPortfolioを見ていただくことができます。少し長くなるためGithubのReadme.mdに続きを書いています。',
    hardships:
